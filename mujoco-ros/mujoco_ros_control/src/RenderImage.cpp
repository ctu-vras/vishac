...
sensor_msgs::CameraInfo RenderImage::GetCamInfo(cv::Mat depth){

    float width = depth.cols;
    float height = depth.rows;
    ...
    cam_info.distortion_model = "mujoco";

    cam_info.D = {2.8302*0.95, 0, 0, 0, 0};
